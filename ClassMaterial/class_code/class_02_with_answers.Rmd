...
We can add lines to our plots using the abline() function. For example abline(v
= 60) would add a vertical line at the value of 60. Can you add a vertical line
