...
states_map |>
  ...
  geom_polygon() + 
  geom_point(aes(x = -71.4347, y = 41.8440), col = "red")   # add PC
...
Let's start with the sample example that is in the class slides. The code below
recreates this simple data frame. Let's reshape it by:
